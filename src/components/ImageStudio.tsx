...
import { ArrowDownToLine, ArrowRight, AudioLines, Check, CircleHelp, Download, Expand, FileAudio, FileText, ImagePlus, Layers3, LoaderCircle, LockKeyhole, Monitor, Pause, PenLine, Play, Plus, RotateCcw, ScanLine, ShieldCheck, SlidersHorizontal, Terminal, Upload, Volume2, VolumeX, X } from 'lucide-react';
